    ...
    useEffect(() => {
        const fetchMetaData = async () => {
            if (metaDataHash) {
                ...
                setCurrentMetaData({ title: "Test Collection", subtitle: "Subtitle" })
            }
        }
        fetchMetaData();
    }, [metaDataHash]);
