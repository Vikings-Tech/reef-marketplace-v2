...
export default function Footer() {
	return (
		<footer
			...
			<div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 z-10">
				<div style={{ zIndex: "5" }} className="xl:grid xl:grid-cols-3 xl:gap-8">
					<div className="space-y-8 xl:col-span-1" style={{ zIndex: "5" }}>
						<div className="flex items-center "><img className="h-12 mr-2" src={Logo} alt="Company name" />
							<div className="font-otoman font-semibold">Oyster</div>
						</div>
						<p className="text-sm italic">
							Create, sell, lend and more all in one Marktplace
						</p>
					</div>
					<div style={{ zIndex: "5" }} className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
						<div style={{ zIndex: "5" }} className="md:grid md:grid-cols-2 md:gap-8">
							<div>
			...
			<img className="absolute w-full bottom-0" style={{ zIndex: "0" }} src={footer} />
